...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="/L2W/professor_home.php/css/reset.css">
  <link rel="stylesheet" href="/L2W/professor_home.php/css/header.css">
  <link rel="stylesheet" href="/L2W/professor_home.php/css/main.css">
        ...
        <div class="row w-100">
                <div class="col-md-3">
                    <div class="card border-white mx-sm-1 p-3" id="caixa">
                        <div class="card text-center border-black shadow text p-3 my-card" id="barra"><span class="fa fa-camera-retro" style="color: #bb7ae6" aria-hidden="true"></span></div>
                        <div class="text-white text-center mt-3"><h4>Vídeos</h4></div>
                        <div class="text-white text-center mt-2"><h1>7</h1></div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border-light mx-sm-1 p-3" id="caixa">
                        ...
                        <div class="text-white text-center mt-3"><h4>Visualizações</h4></div>
                        <div class="text-white text-center mt-2"><h1>1829</h1></div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border-white mx-sm-1 p-3" id="caixa">
                        <div class="card text-center border-black shadow text p-3 my-card" id="barra"><span class="fa fa-comment" style="color: #bb7ae6" aria-hidden="true"></span></div>
                        <div class="text-white text-center mt-3"><h4>Comentários</h4></div>
                        <div class="text-white text-center mt-2"><h1>578</h1></div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border-white mx-sm-1 p-3" id="caixa">
                        <div class="card text-center border-black shadow text p-3 my-card" id="barra"><span class="fa fa-inbox" style="color: #bb7ae6" aria-hidden="true"></span></div>
                        <div class="text-white text-center mt-3"><h4>Inbox</h4></div>
